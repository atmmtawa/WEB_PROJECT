...
<head>
    ...
    <title>Bachelor of science in  computer networking and information</title>
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">>Bachelor of science in  computer networking and information</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Bachelor of science in  computer networking and information_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Bachelor of science in  computer networking and information_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Bachelor of science in  computer networking and information_institutes</h2>
            <?php
