...
<head>
    ...
    <title>Bachelor of Arts with Education</title>
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">Bachelor of Arts with Education</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Bachelor of Arts with Education_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Bachelor of Arts with Education_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Bachelor of Arts with Education_institutes</h2>
            <?php
