...
<head>
    ...
    <title>Bachelor of clinical nutrition and dietetics</title>
    <style>
        body {
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">>Bachelor of clinical nutrition and dietetics</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Bachelor of clinical nutrition and dietetics_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Bachelor of clinical nutrition and dietetics_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Bachelor of clinical nutrition and dietetics_institutes</h2>
            <?php
