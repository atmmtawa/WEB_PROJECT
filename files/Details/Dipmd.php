...
<head>
    ...
    <title>Doctor of medicine</title>
    ...
    <style>
        ...
        .picture-text {
            ...
            box-shadow:0px 0px 0px 0px rgba(0, 0, 0, 0.178);  /*the back shadow*/
            padding: 20px;
            color: rgb(0, 0, 0);
            border-radius: 10px;
            max-width: 600px;
        ...
        .picture-text:hover {
            ...
            transform: translate(-50%, -50%);
            /* background-color: rgba(0, 0, 0, 0.7); */
            box-shadow: 0px 0px 1000px 1000px rgba(0, 0, 0, 0.3); /*another back shadow*/
            padding: 20px;
            color: rgb(0, 0, 0);
            border-radius: 10px;
            max-width: 600px;
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--black);">Doctor of medicine</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Doctor of medicine_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Doctor of medicine_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Doctor of medicine_institutes</h2>
            <?php
