...
<head>
    ...
    <title>Diploma in enviromental health sciences</title>
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">Diploma in enviromental health sciences</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Diploma in enviromental health sciences_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Diploma in enviromental health sciences_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Diploma in enviromental health sciences_institutes</h2>
            <?php
