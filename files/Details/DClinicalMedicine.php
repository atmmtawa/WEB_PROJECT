...
<head>
    ...
    <title>Diploma in clinical medicine</title>
    <style>
        body {
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">Diploma in clinical medicine</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Diploma in clinical medicine_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Diploma in clinical medicine_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Diploma in clinical medicine_institutes</h2>
            <?php
