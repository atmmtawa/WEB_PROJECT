...
<head>
    ...
    <title>Diploma in civil engineering</title>
...
<body>
    <nav>
        <div class="logobrand" style="width:100% !important;text-align:center;">
            <h2 style="color:var(--primary);">Diploma in civil engineering</h2>
        </div>
    </nav>
    <div class="container picture-text" style="margin-top:100px">
        <div class="combination-info">
            <h2>Diploma in civil engineering_description</h2>
            <?php
   include("conn.php");
...
?>
        ...
        <div class="combination-requirements">
            <h2>Diploma in civil engineering_requirements</h2>
            <?php
...
?>
        ...
        <div class="combination-career">
            <h2>Diploma in civil engineering_institutes</h2>
            <?php
