        ...
        <div class="side_bar">
            ...
            <div class="list">
                <ul>
                    ...
                    <li>
                        <a><i class="bi bi-card-heading"></i> Destination</a>
                        <ul class="nested_list">
                            <li><a href="../Details/4-6.php"><i class="bi bi-calendar3-range"></i> Advance Level</a></li>
                            <li><a href="../Details/4-diplo.php"><i class="bi bi-clipboard2-plus-fill"></i> Diploma Level</a></li>
                        </ul>
